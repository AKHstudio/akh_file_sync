  ...
  return (
    <>
      ...
      <ContentSection id="home">
        ...
        <p>
          akhsync は、AKHStudio によって作成された、Minecraft Bedrock Edition
          用のアドオンを開発するためのCLIライブラリです。
        </p>
      ...
      <ContentSection>
        ...
        <p>
          akhsync は、Minecraft Bedrock Edition
          のアドオン開発を支援するための強力なCLIライブラリです。このライブラリを使用することで、ファイルの同期や管理が容易になり、開発プロセスが大幅に効率化されます。
        </p>
      ...
      <ContentSection id="commands">
        <h2>コマンド一覧</h2>
        <p>
          akhsyncは以下のコマンドを提供しています。各コマンドをクリックすると詳細ページに移動します。
        </p>
        ...
        <div className={styles.quickLinks}>
          <QuickLinkCard
            href="/commands/build"
            title="🔨 build"
            description="アドオンをビルドします"
          />
          <QuickLinkCard
            href="/commands/sync"
            title="🔄 sync"
            description="ファイルを同期します"
          />
          <QuickLinkCard
            href="/commands/async"
            title="⚡ async"
            description="非同期処理を実行します"
          />
          <QuickLinkCard
            href="/commands/watch"
            title="👀 watch"
            description="ファイルの変更を監視します"
          />
          <QuickLinkCard
            href="/commands/dist"
            title="📦 dist"
      ...
      <ContentSection id="development">
        <h2>リソース & フィードバック</h2>
        <p>
          akhsyncの詳細情報やフィードバックは以下のリンクからアクセスできます。
        </p>
        ...
        <div style={{ marginTop: '1.5rem' }}>
          ...
          <a
            href="https://www.npmjs.com/package/@akhstudio/akhsync"
            className={styles.linkButton}
            target="_blank"
            rel="noopener noreferrer"
          >
          ...
          <a
            href="https://github.com/AKHstudio/akh_file_sync/issues"
