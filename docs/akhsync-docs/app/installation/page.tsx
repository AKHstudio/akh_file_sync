  ...
  return (
    <>
      ...
      <ContentSection>
        ...
        <p>
          プロジェクトが既に初期化されている場合は、以下のコマンドで{' '}
          <code>akhsync</code> をインストールできます:
        </p>
      ...
      <ContentSection>
        ...
        <CodeBlock
          code='<span class="command">npm install -g @akhstudio/akhsync@latest</span>'
          lang="bash"
        />

        <Alert type="important" title="⚠️ IMPORTANT">
          <p>
            グローバルにインストールする場合は、プロジェクトのディレクトリ構造に注意してください。
          </p>
        </Alert>
      </ContentSection>
      ...
      <ContentSection>
        <h2>インストール方法の選択</h2>
        <p>
          以下の表を参考に、プロジェクトに適したインストール方法を選択してください:
        </p>
